  ...
  slides_capacitacion_textos: { img: string, titulo: string }[] = [
    {
      ...
      titulo: 'Tenemos mentorías personalizadas basada en la cultura organizacional de club de estirpe para mejorar aspectos generales de tu empresa.'
    },
    {
    ...
    },
    {
      ...
      titulo: 'Se genera contenido a partir de distintas fuentes, principalmente de universidades y estudiantes para subirlo a una plataforma de aprendizaje en linea en el que tendrán acceso los miembros del club.'
    },
    {
      img: '/assets/slides-images/capacitacion_otros_emprendedores.svg',
      titulo: 'Se programaran visitas de integración grupal en las empresas de la red para mejorar las areas de oportunidad de los colaboradores de la empresa de la red.'
    }
  ];
